// based on http://golang.org/src/pkg/net/http/fs.go,
// which unfortunately does not export serveContent - ServeContent tries to seek in files to find their length
