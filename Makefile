...
verm: $(MHD)/MHD_config.h src/verm.o src/responses.o src/response_headers.o src/response_logging.o src/replication.o src/decompression.o src/str.o src/mime_types.o $(MHD_LIBRARY)
	cc $(LDFLAGS) -o $@ $^
