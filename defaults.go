...
const ReplicationRequestTimeout = 7200 // want this to be large enough for a very large file over a relatively congested link; we really rely on TCP keepalives at both ends to ensure the connection goes away eventually if the network or other end has died
